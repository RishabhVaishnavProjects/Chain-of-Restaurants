...
<div class="container">   
    ...
    <div ng-app="myapp" ng-controller="usercontroller" ng-init="displayData()">  
		...
		<input type="text" ng-model="keywords2" class="input-medium search-query" placeholder="Enter Employee Id" pattern="[0-9]*" title="ONLY DIGITS ARE ALLOWED">
		...
		<table class="table table-bordered">
		<tr>
		<td>Enter Employee ID</td><td><input type="text" ng-model="eid" placeholder="Enter Employee Id" pattern="[0-9]*" title="ONLY DIGITS ARE ALLOWED"/></td>
		<td>Enter First Name</td><td><input type="text" ng-model="firstname" class="input-medium search-query" placeholder="Enter first name" pattern="[A-Za-z]*" title="ONLY CHARACTERS ARE ALLOWED"></td>
		<td>Enter Last Name</td><td><input type="text" ng-model="lastname" class="input-medium search-query" placeholder="Enter last name" pattern="[A-Za-z]*" title="ONLY CHARACTERS ARE ALLOWED"></td>
		<td>Enter Email</td><td><input type="email" ng-model="email" class="input-medium search-query" placeholder="Enter Email"></td>
		</tr>
		<tr>
		<td>Enter Contact No.</td><td><input type="text" ng-model="contact" class="input-medium search-query" placeholder="Enter Contanct No." pattern="[0-9]*" title="ONLY DIGITS ARE ALLOWED"></td>
		...
		<td colspan="2" align="right" pattern="[A-Za-z]*" title="ONLY CHARACTERS ARE ALLOWED"><button type="submit" class="btn" ng-click="insertData()">Insert</button></td>
		</tr>
		</table>
        </form>
    </div>  
