...
else
{
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST")
	{
		...
		item11='".$item11."',item12='".$item12."',item13='".$item13."',item14='".$item14."',item15='".$item15."' WHERE id = 3";
...
<center> 
    ...
    <tr> 
		<th>Soups and Salads</th><th>AMOUNTs</th>
		<th>Mains</th><th>AMOUNTs</th>
		<th>Desserts And Beverages</th><th>AMOUNTs</th>
    </tr>
	<tr>
		<td>Roasted Red Pepper Soup</td><td><input type="text" id="t1" value="<?php echo $item1 ?>" name="item1"/></td>
		<td>Home Made Pata Gannochi</td><td><input type="text" id="t1" value="<?php echo $item6 ?>" name="item6"/></td>
		<td>Egg Less Chocolate Fondue</td><td><input type="text" id="t1" value="<?php echo $item12 ?>" name="item12"/></td>
	</tr>
	<tr>
		<td>Classic Caeser Salad</td><td><input type="text" id="t1" value="<?php echo $item2 ?>" name="item2"/></td>
		<td>Fussili Mamarosa</td><td><input type="text" id="t1" value="<?php echo $item7 ?>" name="item7"/></td>
		<td>Egg Less Fruit And Nut Fundue</td><td><input type="text" id="t1" value="<?php echo $item13 ?>" name="item13"/></td>
	</tr>
	<tr>
		<td>Crab Shrimp and Avocado Salad</td><td><input type="text" id="t1" value="<?php echo $item3 ?>" name="item3"/></td>
		<td>Ravioli Orange Paprika</td><td><input type="text" id="t1" value="<?php echo $item8 ?>" name="item8"/></td>
		<td>Mocha Fudge Cake</td><td><input type="text" id="t1" value="<?php echo $item14 ?>" name="item14"/></td>
	</tr>
	<tr>
		<td>Florets Grana Padano Soup</td><td><input type="text" id="t1" value="<?php echo $item4 ?>" name="item4"/></td>
		<td>Agnoletti Al Ferno</td><td><input type="text" id="t1" value="<?php echo $item9 ?>" name="item9"/></td>
		<td>Tres Leches</td><td><input type="text" id="t1" value="<?php echo $item15 ?>" name="item15"/></td>
	</tr>
	<tr>
		<td>Minestrone Soup</td><td><input type="text" id="t1" value="<?php echo $item5 ?>" name="item5"/></td>
		<td>Hazze Inut Creme Brulee</td><td><input type="text" id="t1" value="<?php echo $item10 ?>" name="item10"/></td>
		<td></td><td></td>
		<!--<td colspan="6" align="right"><input type="submit" class="btn btn-primary" value="UPDATE" name="submit"/></td>-->
	</tr>
	<tr>
	<td></td><td></td>
	<td>Creme Al Fughni</td><td><input type="text" id="t1" value="<?php echo $item11 ?>" name="item3"/></td>
