...
<div class="container-fluid bg-3 text-center"> 
	<div class="col-sm-8" style="position:absolute;top:15%;left:16%" >
		<div class="well">
		<img src="coffee_house_hdr-wallpaper-3840x2400.jpg" class="img-responsive" style="width:30%" alt="Image" style="float:left">
		<h3 style="position:absolute;top:1%;left:36%">Smally's resto cafe</h3>
		<p align="left" style="color:grey;position:absolute;top:30%;left:36%">Jayanagar 5th Block * Cafe</p>
		<p align="left" style="color:red;position:absolute;top:45%;left:36%">Cafe,American Cost Rs.600 for two people(approx.)</p>
...
<div class="container-fluid bg-3 text-center" > 
	<div class="col-sm-8" style="position:absolute;top:48%;left:16%" >
		...
		<p align="left" style="color:red;position:absolute;top:35%;left:3%">Table Reservation​ & t​​​​​he section/floor assignment will be done as per​ ​availability.Please call 080-45530000 - Smally's resto cafe, </p><p align="left" style="color:red;position:absolute;top:55%;left:3%">to confirm your reservations</p>
		</br>
		</br>
		</br>
		</br>
